...
class NaverJsonToDbConverter {
  constructor() {
    this.outputDir = '/Users/seongjunkim/projects/real-estate-platform/modules/naver-crawler/data/output'
    this.dbPath = '/Users/seongjunkim/projects/real-estate-platform/modules/naver-crawler/data/naver_crawled_data.db'
  ...
  async printFinalStats() {
    ...
    // 실제 단지명 샘플
    console.log('\n📋 실제 단지명 샘플:')
    const samples = await this.getAllQuery(`
...
if (require.main === module) {
  const converter = new NaverJsonToDbConverter()
  converter.run(100) // 처음 100개 파일만 처리
}

module.exports = NaverJsonToDbConverter